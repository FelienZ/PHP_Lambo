...
<section class="flex flex-col justify-center items-center p-4 text-neutral min-h-screen">
    <form action="/projects/save" enctype="multipart/form-data" method="post" class="flex flex-col w-[30%] p-5 rounded-sm gap-8 justify-center bg-white drop-shadow-lg ">
        <?= csrf_field();?>
